...
export function Header({ active, email }: { active: ModuleKey; email?: string | null }) {
  ...
  return (
    <header className="sticky top-0 z-10 bg-night-blue/80 backdrop-blur-md border-b border-white/8 px-4 md:px-8 h-14 flex items-center justify-between flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="w-7 h-7 rounded-full bg-electric-cyan/15 border border-electric-cyan/30 flex items-center justify-center flex-shrink-0">
