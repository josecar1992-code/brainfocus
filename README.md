...
| Sidebar | Orden (10-ago-2026): Hoy, Agenda, Tareas, Asistente, Proyectos, Rutinas, Notas y memorias, Documentos, Vehículos, Configuración — Hoy es el módulo por defecto al iniciar (antes era Agenda). En móvil, el drawer se abre desde la izquierda, junto al botón de hamburguesa |
